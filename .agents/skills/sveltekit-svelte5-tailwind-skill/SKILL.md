...
description: Comprehensive integration skill for building sites with SvelteKit 2, Svelte 5, and Tailwind CSS v4. Covers setup, runes, SSR, forms, styling, routing, and deployment.
version: 1.0.0
scope: integration
...
15 curated guides addressing specific integration challenges:
...
├── SKILL.md                           # This file
├── references/                        # Problem-focused guides (15 files)
